...
char tab_SPI1[16]={"yumin           "};
char tab_SPI2[16]={"jinlijian       "};
char tab_SPI3[16]={"0123456789      "};
char tab_SPI4[16]={"ABCDEFG         "};
...
#define LCD_RW_H      P6OUT|=BIT1      //P6.5高
#define LCD_RW_L      P6OUT&=~BIT1     //P6.5低
